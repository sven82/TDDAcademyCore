...
namespace TddAcademy.Facts
{
    public class GameFacts
    {
        ...
        public void WhenPlayersScore_ScoreShouldBeIncreased(
            string scoredPoints,
        ...
        [Fact]
        public void WhenGameIsInAdvantageAAndBScores_ThenGoBackToDeuce()
        {
        ...
        [Fact]
        public void WhenGameIsInAdvantageBAndAScores_ThenGoBackToDeuce()
        {
